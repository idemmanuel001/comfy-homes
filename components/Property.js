...
export default function Property({ property: { coverPhoto, price, rentFrequency, rooms, title, baths, area, externalID, isVerified }}) {
    return (
        ...
        >
            <div className="flex flex-col items-center overflow-hidden transition-all bg-gray-100 rounded-md shadow-md cursor-pointer w-fit md:my-4 hover:shadow-lg group ">
