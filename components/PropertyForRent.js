...
/* Property card */
export default function PropertyForRent({ property: { coverPhoto, price, rentFrequency, rooms, title, baths, area, externalID }}) {
    return (
        <Link 
        ...
        >
            <div className="flex flex-col items-center overflow-hidden transition-all bg-gray-100 rounded-md shadow-md cursor-pointer w-fit md:my-6 hover:shadow-lg group ">
